...
export const NEIGHBORS=[
 {id:'mio',name:'ミオ',place:'花屋の前',x:-6.5,z:5.3,h:0,color:'#b88886',line:'ありがとう。今日は、花もごきげん。'},
 {id:'noah',name:'ノア',place:'緑のお店の前',x:7.2,z:6,h:0,color:'#b9a063',line:'この香りを、絵にしてみようかな。'},
 {id:'lily',name:'リリ',place:'本屋の小道',x:-14,z:10,h:0,color:'#939bbd',line:'ちょうど、いいところまで読んだの。'},
 {id:'ren',name:'レン',place:'パン屋の庭',x:14,z:12,h:0,color:'#90a27e',line:'焼きたてのパン、一つ持っていく？'},
 {id:'pip',name:'ピップ',place:'池のほとり',x:0,z:17,h:0,color:'#cc9768',line:'ほら、魚もおはようって。'},
 {id:'eve',name:'イヴ',place:'緑のお店の屋上',x:7.2,z:1.5,h:ROOF,color:'#ad8fa3',line:'ここから見る朝が、いちばん好き。'},
 {id:'sol',name:'ソル',place:'橋の向こうの屋上',x:-6.5,z:.5,h:ROOF,color:'#8aaea3',line:'こんな高いところまで！ ありがとう。'},
 {id:'kai',name:'カイ',place:'裏通りのベンチ',x:-13,z:-9,h:0,color:'#a4aa6a',line:'遠回りした朝って、なんだかいいね。'}
];
